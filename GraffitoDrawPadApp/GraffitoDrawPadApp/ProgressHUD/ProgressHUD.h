...
#define HUD_IMAGE_ERASE		    [UIImage imageNamed:@"EraseIcon"]//[UIImage imageNamed:@"ProgressHUD.bundle/progresshud-success.png"]
#define HUD_IMAGE_DRAW			[UIImage imageNamed:@"BrushIcon"]
